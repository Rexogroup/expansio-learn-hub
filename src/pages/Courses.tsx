  ...
  const fetchCourseProgress = async () => {
    try {
      ...
      const {
        data: progressData,
        error: progressError
      } = await supabase.from("lesson_progress").select("lesson_id, completed").eq("user_id", user.id).eq("completed", true);
  ...
  return <div className="min-h-screen bg-gradient-to-br from-background via-background to-secondary">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="mb-12 text-center">
          <h1 className="text-4xl font-bold mb-4 text-foreground">Follow this step-by-step learning process to succeed </h1>
        ...
        {loading ? <div className="text-center py-12">
          ...
          </div> : <div className="max-w-screen-xl mx-auto px-4">
            <div className="relative">
              ...
              {courses.map((course, index) => <div key={course.id} className="relative mb-8 last:mb-0">
                  {/* Step number badge */}
                  ...
                  <Link to={`/course/${course.id}`} className="block ml-16 md:ml-20">
                    <Card className="hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer border-border/50 bg-card backdrop-blur-sm">
                      <div className="flex flex-col md:flex-row gap-6 p-10">
                        {/* Thumbnail */}
                        {course.thumbnail_url && <div className="w-full md:w-80 flex-shrink-0">
                        ...
                        <div className="flex-1 flex flex-col justify-center min-w-0">
                          ...
                          {/* Progress Bar */}
                          {courseProgress.has(course.id) && <div className="mb-3">
